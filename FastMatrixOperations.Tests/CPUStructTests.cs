...
namespace FastMatrixOperations.Tests
{
    public class CPUStructTests : TestBase<Vector3>
    {
        ...
        public void Add()
        {
            ...
            VerifyResults(AddOp(cpu, new Vector3(15, 15, 15), new Vector3(5, 5, 5)), resultArray);
        }
        ...
        public void Subtract()
        {
            ...
            VerifyResults(SubtractionOp(cpu, new Vector3(20, 20, 20), new Vector3(5, 5, 5)), resultArray);
        }
        ...
        public void Multiply()
        {
            ...
            VerifyResults(MultiplicationOp(cpu, new Vector3(15, 15, 15), new Vector3(10, 10, 10)), resultArray);
        }
        ...
        public void Transpose()
        {
            ...
            VerifyResults(TransposeOp(cpu, resultArray, new Vector3(10, 10, 10), new Vector3(5, 5, 5)), resultArray);
        }
    }
}
